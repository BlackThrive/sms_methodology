...
The aim was to produce for Birmingham and Haringey the same set of indicators implemented in the current [Lambeth dashboard](https://lambeth.blackthrive.org/shared-measurement-system/). It has not yet been possible to acquire data for Birmingham and Haringey relating to the mental health indicators that are included in the Lambeth dashboard. As our relationships with relevant public health authorities develop, we aim to update these dashboards with health-related indicators. The table below lists the indicators presently included in the Haringey and Birmingham dashboards, and the sources of their data. 
